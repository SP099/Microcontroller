 ...
 *
 * Created on June 8, 2023, 11:17 PM
 */
...
void main(void) {
    ...
    static char arr[16] = "";
    static int edit_key = 0, flag1 = 0,count_letter = 0, flag2 = 1,count,temp, pos = 0, char_pos;
    static char pwd[8];
    /*flag1 is used to controlling scrolling behavior of the program,when flag1=1 its enter into scrolling mode*/
    /*flag2 is used to ensure that specific block of the code executed only once*/
    init_config();
